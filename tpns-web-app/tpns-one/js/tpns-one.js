...
(function () {
	...
	$('.lifestyle-magazine .double').scissor();
	module.init('lifestyle-magazine');
	$('.lifestyle-magazine').bind("turning", function(event, page) {
		if (page===1){
			event.preventDefault();
		}
	});
	$(".lifestyle-magazine").bind("start", function(event, pageObject) {
