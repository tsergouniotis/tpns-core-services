var ProfileSummaryView = Backbone.View.extend({
	...
	className : "admin-global-controllers-right-items admin-user-profile-preview-nav",
...
var ProfileNotificationsView = Backbone.View.extend({
	...
	className : "admin-global-controllers-right-items admin-user-notifications-nav admin-user-information-desktop",
...
var ProfileMessagesView = Backbone.View.extend({
	...
	className : "admin-global-controllers-right-items admin-user-messages-preview-nav admin-user-information-desktop",
...
var ProfileSelectedArticlesView = Backbone.View.extend({
	...
	className : "admin-global-controllers-right-items admin-user-article-schedule-preview-nav admin-user-information-desktop",
...
var LoggedUserProfileView = Backbone.View.extend({

	tagName : "div",
	className : "admin-global-controllers-right textr",
 	...
 	render: function () {
 		...
 		var profileNotificationsView = new ProfileNotificationsView({
 			model : this.model
 		});
 		var profileMessagesView = new ProfileMessagesView({
 			model : this.model
 		});
 		var profileSelectedArticlesView = new ProfileSelectedArticlesView({
 			model : this.model
 		});
 		...
 		this.$el.append(profileNotificationsView.render().el);
 		this.$el.append(profileMessagesView.render().el);
 		this.$el.append(profileSelectedArticlesView.render().el);
