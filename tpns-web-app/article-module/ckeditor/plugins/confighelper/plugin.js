...
CKEDITOR.plugins.add( 'confighelper',
{
	getPlaceholderCss : function()
    {
		...
		// customisation for TPNS below
        return ".placeholder{ color:#999999; font-family:Arial, Helvetica, sans-serif; font-weight:lighter; font-style:italic; font-size:1.125em; }";
    },
